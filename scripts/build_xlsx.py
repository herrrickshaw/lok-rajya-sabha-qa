...
def main():
    sheets = {
        ...
        "MeitY Scheme Scrutiny": df("meity_scheme_scrutiny.csv"),
    ...
    cover_lines = [
        ...
        ("  MeitY Scheme Scrutiny — MeitY's full scheme catalogue (live WordPress API behind its", False, 10),
        ("    JS-shell site), matched against PQ text, with months since MeitY's own CMS last", False, 10),
        ("    touched each scheme's page. Keyword-heuristic match; treat as a lower bound.", False, 10),
