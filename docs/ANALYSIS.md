...
## Ministry scheme catalogues vs. PQ scrutiny

MeitY, DoT and DPIIT run JS-shell sites with no crawlable page content, but each serves
its scheme catalogue underneath through a public WordPress-backed API — two different
API shapes across the three, verified independently per site rather than assumed identical
(`scripts/compare_wp_json_schemes.py`; the registry's `WP_JSON_MINISTRIES` hook has both DoT
and DPIIT's real endpoints, corrected from an earlier, wrong assumption that they'd match
MeitY's shape). Matched against PQ text by acronym (only when genuinely scheme-specific) or
distinguishing title words (heuristic, a lower bound — see caveats):

| Ministry | Scheme | PQ mentions | Months since site update | Outlay mentioned (₹cr) |
|---|---|---:|---:|---:|
| COMMUNICATION | Special Assistance to States for Capital Investment (SASCI) | 49 | -0.0 | 4000.0 |
| COMMUNICATION | Sanchar Saathi initiative under Digital Intelligence Unit (DIU) project | 38 | 3.9 | — |
| COMMERCE AND INDUSTRY | Industrial Development Scheme (IDS),2017 | 26 | 2.8 | 445.41 |
| COMMERCE AND INDUSTRY | Uttar Poorva Transformative Industrialization Scheme (UNNATI), 2024 | 11 | 3.2 | — |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Production Linked Incentive Scheme – PLI 2.0 for IT Hardware | 9 | 3.9 | — |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Production Linked Incentive Scheme (PLI) for IT Hardware | 9 | 3.9 | — |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Electronic Manufacturing Clusters (EMC) Scheme | 8 | 3.5 | 50.0 |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Electronics Component Manufacturing Scheme | 7 | 13.6 | — |
| COMMERCE AND INDUSTRY | Bharat Audyogik Vikas Yojana (BHAVYA) | 5 | 3.2 | — |
| COMMERCE AND INDUSTRY | National Industrial Corridor Development Programme (NICDP) | 5 | 3.2 | — |
| COMMUNICATION | Invest India | 5 | 10.7 | — |
| COMMUNICATION | Telecom Technology Development Fund (TTDF) | 4 | -0.0 | — |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Modified Electronics Manufacturing Clusters (EMC 2.0) Scheme | 4 | 7.2 | — |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Modified Special Incentive Package Scheme (M-SIPS) | 4 | 15.3 | — |
| ELECTRONICS AND INFORMATION TECHNOLOGY | Digital India Internship Scheme 2026 | 4 | 5.3 | — |

**22 of 44 schemes across 3 ministries
draw zero PQ mentions by name** in this window — including MeitY's SPECS
(semiconductor/electronics-component manufacturing promotion) and the Large Scale
Electronics Manufacturing component of the PLI program, both genuinely verified zero (not a
matching artifact — checked directly against the raw corpus). Either PQs about these use
language this heuristic doesn't catch, or they draw essentially no scheme-specific
parliamentary attention. **15 of 44** haven't been touched
